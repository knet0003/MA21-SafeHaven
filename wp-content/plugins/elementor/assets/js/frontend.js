...
var _default = /*#__PURE__*/function (_elementorModules$Vie) {
  ...
  (0, _createClass2.default)(_default, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                _context.next = 10;
                return this.constructor.getLightbox();
    ...
    value: function onInit() {
      ...
      (_get2 = (0, _get3.default)((0, _getPrototypeOf2.default)(_default.prototype), "onInit", this)).call.apply(_get2, [this].concat(args));
      ...
      this.elements.$links.each(function (index, element) {
        if (_this2.isLightboxLink(element)) {
          _this2.constructor.getLightbox(); // Breaking the iteration when the library loading has already been triggered.
