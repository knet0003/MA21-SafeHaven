 ...
 */
if( !class_exists( 'Darkbiz_Customizer_Slider_Integration' ) ){
	class Darkbiz_Customizer_Slider_Integration extends Darkbiz_Customizer{
		 ...
		 * @package Darkbiz WordPress Theme
		 */
		public static $type = 'darkbiz-slider';

		public static $class = 'Darkbiz_Customizer_Slider_Control';
	...
	new Darkbiz_Customizer_Slider_Integration();
}