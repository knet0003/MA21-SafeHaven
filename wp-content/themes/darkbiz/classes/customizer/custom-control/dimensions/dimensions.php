...
class Darkbiz_Customizer_Dimensions_Control extends WP_Customize_Control {
	 ...
	 * @package Darkbiz WordPress Theme
	 */
	public $type = 'darkbiz-dimensions';
	...
	public function to_json() {
		...
		$this->json['title'] 	= esc_html__( 'Link values together', 'darkbiz' );
	...
	protected function content_template() {
		...
		<ul class="desktop control-wrap active">
	        ...
	        <li class="dimension-wrap">
	            <div class="link-darkbiz-dimensions">
	...
	protected function l10n( $id = false ) {
		$translation_strings = array(
			'desktop_top' 		=> esc_html__( 'Top', 'darkbiz' 	),
			'desktop_right' 	=> esc_html__( 'Right', 'darkbiz' 	),
			'desktop_bottom' 	=> esc_html__( 'Bottom', 'darkbiz' ),
			'desktop_left' 		=> esc_html__( 'Left', 'darkbiz' 	),
			'tablet_top' 		=> esc_html__( 'Top', 'darkbiz' 	),
			'tablet_right' 		=> esc_html__( 'Right', 'darkbiz' 	),
			'tablet_bottom' 	=> esc_html__( 'Bottom', 'darkbiz' ),
			'tablet_left' 		=> esc_html__( 'Left', 'darkbiz' 	),
			'mobile_top' 		=> esc_html__( 'Top', 'darkbiz' 	),
			'mobile_right' 		=> esc_html__( 'Right', 'darkbiz' 	),
			'mobile_bottom' 	=> esc_html__( 'Bottom', 'darkbiz' ),
			'mobile_left' 		=> esc_html__( 'Left', 'darkbiz' 	),
		);
		if ( false === $id ) {
