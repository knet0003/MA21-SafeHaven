...
if( !class_exists( 'Darkbiz_Customizer_Dimensions_Integration' ) ){

	class Darkbiz_Customizer_Dimensions_Integration extends Darkbiz_Customizer{
		...
		public static $type = 'darkbiz-dimensions';

		public static $class = 'Darkbiz_Customizer_Dimensions_Control';
		...
		public function start( $instance , $wp_customize ){
			...
			foreach( $instance::$fields[ self::$type ] as $field ){
				...
				if( !isset( $field[ 'dimension' ] ) ){
					$err = esc_html__( 'Missing key "dimension" passed for Dimension Control.', 'darkbiz' );
	...
	new Darkbiz_Customizer_Dimensions_Integration();
}
